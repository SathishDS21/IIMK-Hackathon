...
model = SVC(kernel='linear', probability=True, random_state=42)  # Linear kernel for text classification
...
joblib.dump(model, "publishability_svm_classifier.pkl")
...
output_file_path = os.path.join(output_dir, "SVM-publishability_results.xlsx")
